...
def create_servable_embeddings_model(embeddings, **kwargs):
    return create_model_for('servable-embeddings', embeddings, None, **kwargs)


def load_servable_embeddings_model(filename, **kwargs):
    return load_model_for('servable-embeddings', filename, **kwargs)


@register_model(task='servable-embeddings', name='default')
...
@register_exporter(task='servable-embeddings', name='default')
...
@register_exporter(task='servable-embeddings', name='preproc')
